...
<section id="" class=" shop__detail--rate rateSection">
	<div class="shop__detail--rateTable" id="ratebox" v-cloak="">
		<h3 class="titleSub">
			ราคาอ้างอิงซื้อทองคำและแพลทินัม
		</h3>
		<p>
			ราคาตลาดทองคำ ราคาตลาดแพลทินัม และราคาตลาดเงินแต่ละประเภท<br>
			ราคาที่แสดงด้านล่างนี้แตกต่างกันไปขึ้นอยู่กับรูปร่าง ดังนั้นโปรดติดต่อเราทางโทรศัพท์เพื่อขอรายละเอียด
		</p>
		<br>
			...
			<tbody>
				<tr>
					<th class="rateTable--gold" colspan="2">
						ราคาอ้างอิงวันนี้สำหรับทองคำและแพลตตินัม 1 กรัมรวมกัน
					</th>
				</tr>
				<tr>
			...
			<tbody>
				<tr>
					<th class="rateTable--pt" colspan="2">
						ราคาอ้างอิงวันนี้สำหรับแพลทินัม 1 กรัม
					</th>
				</tr>
				<tr>
			...
			<tbody>
				<tr>
					<th class="rateTable--pd" colspan="3">
						ราคาอ้างอิงวันนี้สำหรับแพลเลเดียม 1 กรัม
					</th>
				</tr>
				<tr>
			...
			<tbody>
				<tr>
					<th class="rateTable--sv" colspan="3">
						ราคาอ้างอิงวันนี้สำหรับเงิน 1 กรัม
					</th>
				</tr>
				<tr>
