...
ท่านสามารถติดต่อมาปรึกษากับเราได้ทุกเมื่อ
					...
					<div class="qa__list js__more--item3">
						<dl class="qa__list__inner">
							<dt class="qa__list__q">อัตราแลกเปลี่ยนเงินเยน (ค่าเงินเยนอ่อนหรือแข็ง) มีผลต่อราคาประเมินหรือไม่?</dt>
							<dd class="qa__list__a">
							เนื่องจากเพชรและอัญมณีไม่ได้ถูกผลิตในญี่ปุ่นโดยตรง ราคาจึงได้รับผลกระทบจากอัตราแลกเปลี่ยนเงินเยน
							โดยทั่วไปหากค่าเงินเยนอ่อนตัวลงมูลค่าของเพชรจะเพิ่มขึ้น ส่งผลให้ราคาตลาดสินค้ามือสองสูงขึ้น และทำให้ราคาประเมินรับซื้อสูงขึ้นตามไปด้วย							</dd>
						</dl>
					</div>
					<div class="qa__list js__more--item3">
						<dl class="qa__list__inner">
					...
					<div class="qa__list js__more--item3">
						<dl class="qa__list__inner">
							<dt class="qa__list__q">ทำไมถึงต้องใช้บัตรยืนยันตัวตน ？</dt>

							<dd class="qa__list__a">การระบุตัวตนของผู้ขายเป็นสิ่งที่กฎหมายผู้ค้าของเก่ากำหนดให้ต้องมี และเราจำเป็นต้องเก็บบันทึกเอาไว้เพื่อจุดประสงค์ดังกล่าว โดยจะไม่นำไปใช้เพื่อเหตุผลอื่นใด</dd>
						</dl>
					</div>
				</div>
